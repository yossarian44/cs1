...
--takes an  element h and a list b and returns list of pairs (h, e)
--where e is and element of b
pairelt: a -> list b -> list (pair a b)
pairelt someA nil = nil
pairelt someA (b::tb) = (mkPair someA b)::(pairelt someA tb)

--given a list of a and a list of b, return list of all a b pairs
...
--set_String: (Serialize a) => set a -> String
--set_String (mkSet nil) = ""
--set_String (mkSet (h::nil)) = (toString h)
--set_String (mkSet (h::t)) = (toString h) ++ "," ++ (list_string t)

set_toString (mkSet l) = "{" ++ (list_string l) ++ "}"
